...
class CodecFakeTestDataset(Dataset):
    """
    PyTorch Dataset for loading preprocessed audio samples from the CodecFake dataset.
    ...
    Example
    -------
    >>> dataset = CodecFakeBalancedTestDataset("path/to/real", "path/to/fake", max_real=45000, max_fake=30000)
